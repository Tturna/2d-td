...
public static class AssetManager
{
    ...
    public static void LoadAllAssets()
    {
        ...
        LoadTexture("chunk","sprites/Enemies/Chunk/chunk_body");
        ...
        LoadTexture("btn_square_small_empty", "sprites/UI/button_smallsquare_empty");
        ...
        LoadTexture("nextlevel_button", "sprites/UI/nextlevel_button");
        ...
        LoadSound("mortarfire", "sound/turret/mortarfire");
